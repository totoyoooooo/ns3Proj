...
CC = ['g++-10']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wno-error', '-std=c++17', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-fno-strict-overflow', '-g', '-O2', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-fno-strict-overflow', '-g', '-O2', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-fno-strict-overflow', '-g', '-O2', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-fno-strict-overflow', '-g', '-O2', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['tutorial', 'routing', 'error-model', 'traffic-control', 'wireless', 'matrix-topology', 'realtime', 'tcp', 'channel-models', 'energy', 'ipv6', 'socket', 'udp-client-server', 'udp', 'naming', 'stats']
...
LIBPATH_PYEMBED = ['/usr/lib/python3.12/config-3.12-x86_64-linux-gnu']
LIBPATH_PYEXT = ['/usr/lib/python3.12/config-3.12-x86_64-linux-gnu']
LIBPATH_PYTHON3.12 = ['/usr/lib/python3.12/config-3.12-x86_64-linux-gnu']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/home/w/ns3proj/ns-3.35-switchml/build/src/fd-net-device', '/home/w/ns3proj/ns-3.35-switchml/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/10', '/home/w/ns3proj/ns-3.35-switchml/build/lib', '/home/w/ns3proj/ns-3.35-switchml/build']
...
cfg_files = ['/home/w/ns3proj/ns-3.35-switchml/build/ns3/config-store-config.h', '/home/w/ns3proj/ns-3.35-switchml/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
