...
void
UDPecn::SetECN (uint8_t ecn)
{
  m_udpecn = ecn;
}

uint8_t
UDPecn::GetECN (void) const
{
  return m_udpecn;
}

TypeId
UDPecn::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SocketUdpEcnTag")
    .SetParent<Tag> ()
    .SetGroupName("Network")
    .AddConstructor<SocketPriorityTag> ()
    ;
...
TypeId
UDPecn::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
UDPecn::GetSerializedSize (void) const
{
  return sizeof (uint8_t);
}

void
UDPecn::Serialize (TagBuffer i) const
{
  i.WriteU8 (m_udpecn);
}

void
UDPecn::Deserialize (TagBuffer i)
{
  m_udpecn = i.ReadU8();
}

void
UDPecn::Print (std::ostream &os) const
{
  os << "ecn-marking = " << m_udpecn;
}
...
void
SwmlRouteTag::SetSwmlRouteTag (uint16_t appid,  uint16_t hostid)
{
  m_app_id = appid;
  m_host_id = hostid;
}
...
void
SwmlRouteTag::GetSwmlRouteTag (uint16_t &appid,  uint16_t &hostid) const
{
  appid = m_app_id;
  hostid = m_host_id;
}
...
TypeId
SwmlRouteTag::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SocketSwmlRouteTag")
    .SetParent<Tag> ()
    .SetGroupName("Network")
    .AddConstructor<SocketPriorityTag> ()
    ;
...
TypeId
SwmlRouteTag::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
SwmlRouteTag::GetSerializedSize (void) const
{
  return sizeof (uint32_t);
}

void
SwmlRouteTag::Serialize (TagBuffer i) const
{
  i.WriteU16 (m_app_id);
  i.WriteU16 (m_host_id);
}

void
SwmlRouteTag::Deserialize (TagBuffer i)
{
  m_app_id = i.ReadU16();
  m_host_id = i.ReadU16();
}
...
void
SwmlRouteTag::Print (std::ostream &os) const
{
  os << "m_app_id = " << m_app_id;
