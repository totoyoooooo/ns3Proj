...
public:
  ...
  int64_t AssignStreams (int64_t stream);
    //lzyadd for ECMP
  static int job_ecmp_table[128][128];
  static bool job_map[128];
...
private:
   ...
   */
  //lzychange
  Ptr<Ipv4Route> LookupGlobal (ns3::Ptr<const Packet> p, ns3::Ipv4Header ipv4header, Ipv4Address dest, Ptr<NetDevice> oif = 0);
